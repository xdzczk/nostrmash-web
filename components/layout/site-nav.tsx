...
/** Mobile bottom bar stays at five items for touch targets and label legibility. */
          ...
          {mobileNavItems.map((item) => {
            ...
            return (
              <Link
                ...
                href={item.href}
                aria-current={active ? "page" : undefined}
                className={`nm-pressable focus-visible:ring-accent-soft/70 flex min-h-12 min-w-0 flex-1 items-center justify-center rounded-xl border border-transparent px-2 py-2 text-xs font-medium focus-visible:ring-2 focus-visible:outline-none ${
                  active
